...
Maximum posterior density (MPD) model fits to the commercial mean weight index from the Reference case model and Scenarios 1-3 are shown in Figures \@ref(fig:fig-base-mean-weight-3cd) to \@ref(fig:fig-base-mean-weight-3cd-sc3). 

Posterior biomass estimates from the Reference case model are shown in Figure \@ref(fig:fig-model-ref-biomass-3cd).

The three alternative treatments of the mean weight index all resulted in reduced estimates of biomass for 2019-2020 and reduced 2021 projection (Table \@ref(tab:tab-est-biomass-3cd); Figure \@ref(fig:fig-sens-biomass-3cd)). The percentage change for the 2021 biomass projection ranged from -18.2% in Scenario 1 to -14.1% in Scenario 3 (Table \@ref(tab:tab-est-biomass-3cd-per)), indicating that bias was greatest when there was no attempt to replace the missing data. Posterior estimates of recruitment were much lower in 2019-2020 in the three alternative scenarios compared to the Reference case, with percentage change ranging from -53.1% to -32.4% (Table \@ref(tab:tab-est-recruit-3cd); Figure \@ref(fig:fig-sens-recr-3cd)). 

## Area 5ABCD

Maximum posterior density (MPD) model fits to the commercial mean weight index from the Reference case model and Scenarios 1-3 are shown in Figures \@ref(fig:fig-base-mean-weight-5abcd) to \@ref(fig:fig-base-mean-weight-5abcd-sc3). 

Posterior biomass estimates from the Reference case model are shown in Figure \@ref(fig:fig-model-ref-biomass-5abcd).

Scenario 1 resulted in increased estimates of biomass for 2019-2020 and the 2021 projection, while Scenarios 2 and 3 resulted in decreases (Table \@ref(tab:tab-est-biomass-5abcd); Figure \@ref(fig:fig-sens-biomass-5abcd)). The percentage changes for the 2021 biomass projection were smaller than for Area 3CD, and ranged from -6.8% in Scenario 2 to 9.1% in Scenario 1 (Table \@ref(tab:tab-est-biomass-5abcd-per)). Posterior estimates of recruitment in 2019-2020 differed by year and scenario compared to the Reference case, with percentage change ranging from -13.3% to 66.6% (Table \@ref(tab:tab-est-recruit-5abcd); Figure \@ref(fig:fig-sens-recr-5abcd)).
