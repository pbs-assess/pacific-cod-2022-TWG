...
```{r fig-sens-biomass-3cd-impute, fig.cap="Sensitivity of biomass estimates to the eight individual imputed treatments of the commercial mean weight index, Area 3CD."}
b.plot(c(base.model.3cd, sens.models.33), c(base.model.3cd.name, sens.models.name.33))
```

```{r fig-sens-biomass-3cd-impute-avg, fig.cap="Sensitivity of biomass estimates to the eight individual imputed treatments of the commercial mean weight index, Area 3CD."}
b.plot(c(base.model.3cd,avg.impute.model.3cd), c(base.model.3cd.name,avg.impute.model.3cd.name))
```

```{r fig-sens-biomass-3cd-shortcut, fig.cap="Sensitivity of biomass estimates to the shortcut imputed treatments of the commercial mean weight index, Area 3CD."}
