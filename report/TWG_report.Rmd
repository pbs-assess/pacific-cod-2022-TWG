...
```{r fig-sens-biomass-3cd-impute-avg, fig.cap="Reference model posterior biomass estimates compared to model-averaged estimates from the eight replicate models with imputed mean weight values, Area 3CD."}
