...
```{r tab-compare-all-mean-weight-3cd, tab.cap="Values for survey mean weight index, observed commercial mean weight index and predicted mean weight index, Area 3CD. Note that the 2019 observed commercial mean weight value is not shown because this analysis assumes there was no commercial sampling in the years 2018-2020."}
...
```{r tab-compare-all-mean-weight-5abcd, tab.cap="Values for survey mean weight index, observed commercial mean weight index and predicted mean weight index, Area 5ABCD."}
