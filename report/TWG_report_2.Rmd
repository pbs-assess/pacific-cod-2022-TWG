...
```{r fig-meas_v_calc_weights-3cd, fig.cap="Measured vs calculated weights from the WCVI survey, all years all depth strata, Area 3CD", out.width="4in"}
knitr::include_graphics(here::here("report/figures/3cd/Measured_v_Calc_weights_3CD.png"))

```

```{r fig-meas_v_calc_weights-3cd, fig.cap="Measured vs calculated weights from the WCVI survey, all years all depth strata, Area 5ABCD", out.width="4in"}
...
```{r fig-comm_vs_survey_weights-3cd, fig.cap="Commercial mean weights vs survey mean weights, excluding the 2017 commercial mean weight, Area 3CD", out.width="4in"}
knitr::include_graphics(here::here("report/figures/3cd/Comm_v_Survey_weights_3CD_NO_2017.png"))

```


```{r fig-comm_vs_survey_weights-3cd-b, fig.cap="Commercial mean weights vs survey mean weights, including the 2017 commercial mean weight, Area 3CD", out.width="4in"}
...
```{r fig-comm_vs_survey_weights-5abcd, fig.cap="Commercial mean weights vs survey mean weights, excluding the 2007 commercial mean weight, Area 5ABCD", out.width="4in"}
knitr::include_graphics(here::here("report/figures/5abcd/Comm_v_Survey_weights_5ABCD_NO_2007.png"))

```

```{r fig-comm_vs_survey_weights-5abcd-b, fig.cap="Commercial mean weights vs survey mean weights, including the 2007 commercial mean weight, Area 5ABCD", out.width="4in"}
