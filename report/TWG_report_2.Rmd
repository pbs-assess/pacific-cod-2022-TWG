...
For Area 3CD, there was a WCVI survey in 2018, but no survey in 2020. Therefore, for Area 3CD, for the 2018-2020 period of interest, we can only update the commercial mean weight index in 2018 (**Scenario 1**). Values are provided in Table \@ref(tab:tab-mean-weight-recent-3cd).

For Area 5ABCD, there was a synoptic surveys in 2019. Therefore we present two alternative treatments of the commercial mean weight data for 2018-2020. In **Scenario 1**, we updated 2019 with the 2019 predicted commercial mean weight, and interpolated between the 2017 and 2019 predicted commercial mean weights to obtain mean weight value for 2018. In **Scenario 2**, we update only 2019 with the predicted commercial mean weight. Values are provided in Table \@ref(tab:tab-mean-weight-recent-5abcd).
