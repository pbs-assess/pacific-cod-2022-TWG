...
where the $\phi$ parameter predicts the rate and shape of the Gamma distribution.
...
caption <- "Values for survey mean weight index, observed commercial mean weight index and predicted mean weight index, Area 3CD."

tab <- readr::read_csv(here::here("report/figures/3cd/Comm_v_Survey_weights_3CD_all_compare.csv"))
tab[,2:4]<- round(tab[,2:4],3)
knitr::kable(tab,
              caption = caption,
...
caption<-"Values for survey mean weight index, observed commercial mean weight index and predicted mean weight index, Area 5ABCD."
