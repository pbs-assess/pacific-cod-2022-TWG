...
1. Whether the development of the survey mean weight index and the predicted commercial mean weight index require more work, including simulation-testing;

2. Whether this work requires full peer review through CSAS;

3. Whether further work is needed on the assessment itself (e.g., development of a recruitment index);

4. Knowledge that the 2022 WCVI data will not be available until Fall 2022; and

5. Availability of Science staff, given the time already spent on these exercises.
