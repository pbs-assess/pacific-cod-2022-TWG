...
```{r fig-comm-vs-survey-weights-3cd, fig.cap="Commercial mean weights and survey mean weights, Area 3CD", out.width="4in"}
knitr::include_graphics(here::here("report/figures/3cd/Comm_v_Survey_weights_3CD.png"))

```

```{r fig-comm-vs-survey-weights-3cd-2, fig.cap="log commercial mean weights vs log survey mean weights, Area 3CD. The blue line shows linear fit.", out.width="4in"}
...
```{r fig-comm-vs-survey-weights-5abcd, fig.cap="Commercial mean weights and survey mean weights, Area 5ABCD", out.width="4in"}
knitr::include_graphics(here::here("report/figures/5abcd/Comm_v_Survey_weights_5ABCD.png"))

```

```{r fig-comm-vs-survey-weights-5abcd-2, fig.cap="log commercial mean weights vs log survey mean weights, Area 5ABCD. The blue line shows linear fit.", out.width="4in"}
knitr::include_graphics(here::here("report/figures/5abcd/lnSurvey_v_lnCom_with_lm_fit_5ABCD.png"))

```

```{r fig-comm-vs-survey-weights-5abcd-2b, fig.cap="log commercial mean weights vs log survey mean weights, excluding the lowest value in 2007, Area 5ABCD. The blue line shows linear fit.", out.width="4in"}
knitr::include_graphics(here::here("report/figures/5abcd/lnSurvey_v_lnCom_with_lm_fit_5ABCD_NO_2007.png"))

```

\clearpage

```{r all-mean-weight-series-3cd, fig.cap="Commercial mean weights vs survey mean weights, Area 3CD", out.width="4in"}
knitr::include_graphics(here::here("report/figures/3cd/Compare_obs_v_predicted_3CD.png"))
```

```{r all-mean-weight-series-5abcd, fig.cap="Commercial mean weights vs survey mean weights, Area 5ABCD", out.width="4in"}
